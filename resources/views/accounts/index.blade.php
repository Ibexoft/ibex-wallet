...
@section('sidebar')
    <div class="col-lg-3 mb-4 mb-lg-0">
        <div class="card">
            <form id="transaction-filter-form" action="{{ route('accounts.index') }}" method="GET">
                ...
                <div class="card-body pb-0">
                    <div id="filterCollapse" class="pt-0 collapse show" data-bs-parent="#accordionExample">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="accountSearch" name="search" placeholder="Search by name" value="{{ request('search') }}">
                        </div>
