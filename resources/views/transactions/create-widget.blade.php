    ...
    <div class="card-body">
        <form method="POST" action="{{ route('transactions.store') }}">
            ...
            <div class="form-group row">
                <label for="type" class="col-md-4 col-form-label text-md-right">Type <span
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="details" type="text" class="form-control @error('details') is-invalid @enderror"
                        name="details" autocomplete="details">
            ...
            <div class="form-group row">
                <label for="src_account_id" class="col-md-4 col-form-label text-md-right">Account <span
                        class="text-danger">*</span></label>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <select name="dest_account_id" id="dest_account_id"
                        class="form-control @error('dest_account_id') is-invalid @enderror"
            ...
            <div class="form-group row">
                <label for="wallet_id" class="col-md-4 col-form-label text-md-right">Wallet <span
                        class="text-danger">*</span></label>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="spent_on" type="text" class="form-control @error('spent_on') is-invalid @enderror"
                        name="spent_on" autocomplete="spent_on">
